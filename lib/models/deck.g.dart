...
extension DeckQueryFilter on QueryBuilder<Deck, Deck, QFilterCondition> {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> totalCardsEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> totalCardsGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> totalCardsLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Deck, Deck, QAfterFilterCondition> totalCardsBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DeckQuerySortBy on QueryBuilder<Deck, Deck, QSortBy> {
  ...
  QueryBuilder<Deck, Deck, QAfterSortBy> sortByTotalCards() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalCards', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> sortByTotalCardsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DeckQuerySortThenBy on QueryBuilder<Deck, Deck, QSortThenBy> {
  ...
  QueryBuilder<Deck, Deck, QAfterSortBy> thenByTotalCards() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalCards', Sort.asc);
    });
  }

  QueryBuilder<Deck, Deck, QAfterSortBy> thenByTotalCardsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalCards', Sort.desc);
    });
  }
...
extension DeckQueryWhereDistinct on QueryBuilder<Deck, Deck, QDistinct> {
  ...
  QueryBuilder<Deck, Deck, QDistinct> distinctByTotalCards() {
    return QueryBuilder.apply(this, (query) {
...
extension DeckQueryProperty on QueryBuilder<Deck, Deck, QQueryProperty> {
  ...
  QueryBuilder<Deck, int, QQueryOperations> totalCardsProperty() {
    return QueryBuilder.apply(this, (query) {
